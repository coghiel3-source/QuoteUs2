      ...
      <div className="container mx-auto max-w-4xl px-4 -mt-12">
        <Card className="shadow-xl border-none mb-8">
          <CardContent className="p-8 md:p-12 prose prose-slate max-w-none">
            ...
            <p>
              If you request a quote for auto insurance on the Website, we collect Personal Information related to the driver like date of birth, sex, marital status, job status, driving history, licence class, insurance status, name of current insurer, price of current insurance per month, details regarding any accidents or insurance violations the driver and details about the vehicle include the year, make and model, and number of kilometers driven per year in some case drivers licenses details. Necessarily, we will have to disclose this information to auto insurance companies, brokers, or other parties to get you a quote.
            </p>

            <h3>Home Insurance</h3>
            <p>
              If you request a quote for home insurance, we collect information such as details regarding your property like address, type of property, and mortgages on the property; Personal Information about the occupant such as first and last name, date of birth, job status, years of property insurance, email address, and damage claims history, occupation and rental information); and property construction details like year property was built, type of exterior, number of bathrooms, property's estimated replacement cost, and square footage.
            </p>

            <h3>Life Insurance</h3>
            <p>
              If you request a quote for life insurance, we collect information such as details regarding the applicant's coverage needs such as type of coverage, coverage amount, and optional insurance products; and Personal Information about the applicant like first and last name, date of birth, location, sex, smoking habits, email address, and phone number.
            </p>
            ...
            <p>
              Your credit report may include information such as the types and amounts of credit advanced to you, payment histories, negative banking items, collection actions, legal proceedings, previous bankruptcies and other information reported by your creditors. You will have authorized credit reporting agencies to provide such information to us. If we are unable to obtain your credit report based on your name, date of birth and mailing address alone, we may request you to provide other information, such as your social insurance number, on an optional basis which we will use to help us identify you with a credit reporting agency.
            </p>

            <h3>Credit Reports</h3>
            <p>
              To obtain a free credit report, as detailed in the Terms of Service, you will be required to provide us certain Personal Information for the purpose of the generating the free credit report. The necessary Personal Information includes: your name, email address, date of birth, annual income, phone number, social insurance number, and address. We disclose this Personal Information to our partner Equifax. Equifax may use this Personal Information for their own purposes as detailed in Equifax's terms of service and privacy policy. We will continue to use this Personal Information to update your credit report from time to time, and accordingly, will also use this Personal Information to provide updated credit reports, which you can find in your account.
            </p>

            <h3>Credit Card Applications</h3>
            <p>
              We may also use and disclose your Personal Information to facilitate your applications for credit cards on our Website. We will collect Personal Information such as: first and last name, email address, phone number, date of birth, address and address history, annual income, employment status and other employment information, financial assets, and social insurance number. We may either collect this information and disclose it to a specific credit card provider, or use the information to assess the best credit card for you and provide the information to the applicable credit card providers.
            </p>

            <h3>Location Information</h3>
            <p>
              Certain third-party products and services are only available in certain areas, and therefore we may ask for your location, either by requesting your postal code, province, city, and/or address or by using Website Information.
            </p>

            <h3>Transactional Notifications</h3>
            <p>
              We provide notifications for certain activities relating to your use of our Services despite your indicated e-mail preferences, for example we may send you notices of any updates to our Terms of Use or Privacy Policy.
            </p>

            <h3>Marketing Communications and Product Recommendations</h3>
            <p>
              If you sign-up to receive newsletters, updates, or marketing communications from us, we will use your Personal Information to send you such communications. You may opt-out of receiving such communications at any time by following the unsubscribe instructions in the communication or by contacting us directly.
            </p>

            <h2>Limiting Use, Disclosure and Retention</h2>
            <p>
              We will not use or disclose your Personal Information for any purpose other than those identified above, except with your consent. We will retain your Personal Information for as long as necessary to fulfill the purpose(s) for which it was collected and to comply with applicable laws. When your Personal Information is no longer required, we will securely destroy it or render it anonymous.
            </p>

            <h2>Accuracy</h2>
            <p>
              We will make reasonable efforts to ensure that your Personal Information is accurate, complete, and up-to-date as is necessary for the purposes for which it is to be used. You are responsible for informing us of any changes to your Personal Information.
            </p>

            <h2>Safeguards</h2>
            <p>
              We have implemented appropriate physical, organizational, and technological measures to protect your Personal Information against unauthorized access, disclosure, copying, use, or modification. These safeguards include:
            </p>
            <ul>
              <li>Secure storage of physical documents;</li>
              <li>Use of encryption and secure communication protocols;</li>
            ...
            <h2>Openness</h2>
            <p>
              We are committed to making our policies and practices relating to the management of your Personal Information readily available to you. This Privacy Policy is available on our Website at all times. If you have any questions about our privacy practices, please contact us using the information provided below.
            </p>

            <h2>Individual Access</h2>
            <p>
              Upon request, we will inform you of the existence, use, and disclosure of your Personal Information and provide you with access to that information. You may challenge the accuracy and completeness of your Personal Information and have it amended as appropriate. In certain circumstances, we may not be able to provide access to all of your Personal Information. If we refuse your request for access, we will notify you in writing, document our reasons, and inform you of available recourse.
            </p>

            <h2>Challenging Compliance</h2>
            <p>
              You may challenge our compliance with this Privacy Policy by contacting our Privacy Officer. We will investigate all complaints and, if a complaint is found to be justified, we will take appropriate measures to resolve the issue, including amending our policies and practices if necessary.
            </p>

            <h2>Cookies and Similar Technologies</h2>
            <p>
              We use cookies and similar technologies to enhance your experience on our Website. Cookies are small text files that are stored on your device when you visit a website. They help us recognize you, remember your preferences, and analyze how you use our Website. You can manage your cookie preferences through your browser settings. However, disabling cookies may affect the functionality of certain features of our Website.
            </p>
            ...
            <p>
              We may update this Privacy Policy from time to time to reflect changes in our practices or applicable laws. We will post the updated Privacy Policy on our Website with the revised "Last Updated" date. We encourage you to review this Privacy Policy periodically.
            </p>
